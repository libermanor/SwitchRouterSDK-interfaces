...
/**
 *  Supported devices: Spectrum, Spectrum2, Spectrum3.
 *  This function is used to add/del a virtual port to/from a bridge.
 *
 * @param[in] handle - SX-API handle
 ...
 *  If there is no counter bound to the bridge, the API will return SX_STATUS_ENTRY_NOT_FOUND and
 ...
 * @return SX_STATUS_SUCCESS if operation completes successfully
 * @return SX_STATUS_PARAM_ERROR if any input parameter is invalid
 * @return SX_STATUS_ENTRY_NOT_FOUND if bridge is not found in DB or no counter is bound
 * @return SX_STATUS_ERROR if unexpected behaviour occurs
 */
