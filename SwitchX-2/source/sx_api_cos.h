 ...
 */
sx_status_t sx_api_cos_log_verbosity_level_set(
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_log_verbosity_level_get(
        const sx_api_handle_t           handle,
        const sx_log_verbosity_target_t verbosity_target,
 ...
 */
sx_status_t sx_api_cos_port_default_prio_set(
        const sx_api_handle_t   handle,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_default_prio_get(
        const sx_api_handle_t   handle,
        const sx_port_log_id_t  log_port,
 ...
 * @return SX_STATUS_MEMORY_ERROR error handling memory
 */
sx_status_t sx_api_cos_port_prio_ingress_regen_set(
        const sx_api_handle_t   handle,
        const sx_port_log_id_t  log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_prio_ingress_regen_get(
        const sx_api_handle_t   handle,
        const sx_port_log_id_t  log_port,
        const sx_cos_priority_t source_priority,
 ...
 */
sx_status_t sx_api_cos_port_tc_prio_map_set(
        const sx_api_handle_t        handle,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_tc_prio_map_get(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
        const sx_cos_priority_t         priority,
 ...
 * @return SX_STATUS_MEMORY_ERROR error handling memory
 */
sx_status_t sx_api_cos_port_trust_set(
        const sx_api_handle_t      handle,
        const sx_port_log_id_t     log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_trust_get(
        const sx_api_handle_t       handle,
        const sx_port_log_id_t      log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_ip_dscp_to_prio_set(
        const sx_api_handle_t   handle,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_ip_dscp_to_prio_get(
        const sx_api_handle_t   handle,
        const sx_cos_dscp_t     dscp,
              sx_cos_priority_t *priority_p);
 ...
 *  This API is not supported in the current release.
 *
 *  This function retrieves the global hardware cos capabilities.
 *
 * @param[in]   handle                    - SX-API handle
 ...
 * [max_policers_global   - maximum number of active global policers]
 *
 * @return SX_STATUS_SUCCESS if operation completes successfully
 * @return SX_STATUS_PARAM_ERROR if an input parameter is invalid
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_capabilities_get(
        const sx_api_handle_t       handle,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_ets_set(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_ets_get(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_ets_general_configuration_set(
        const sx_api_handle_t                       handle,
        const sx_port_log_id_t                      log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_ets_general_configuration_get(
        const sx_api_handle_t                       handle,
        const sx_port_log_id_t                      log_port,
 ...
 */
sx_status_t sx_api_cos_port_buff_set(
        const sx_api_handle_t           handle,
        const sx_access_cmd_t           cmd,
        const sx_port_log_id_t          log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_buff_get(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
 ...
 */
sx_status_t sx_api_cos_port_prio_buff_map_set(
        const sx_api_handle_t           handle,
        const sx_access_cmd_t           cmd,
        const sx_port_log_id_t          log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_cos_port_prio_buff_map_get(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
              sx_cos_port_prio_buff_t   *prio_to_buff_p);
 ...
 */
sx_status_t sx_api_cos_qcn_port_prio_mode_set(
        const sx_api_handle_t                       handle,
        const sx_port_log_id_t                      log_port,
        const sx_cos_priority_t                     priority,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_port_prio_mode_get(
        const sx_api_handle_t                       handle,
        const sx_port_log_id_t                      log_port,
        const sx_cos_priority_t                     priority,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_port_prio_enable_set(
        const sx_api_handle_t                       handle,
        const sx_port_log_id_t                      log_port,
        const sx_cos_priority_t                     priority,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_port_prio_enable_get(
        const sx_api_handle_t                       handle,
        const sx_port_log_id_t                      log_port,
        const sx_cos_priority_t                     priority,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_port_prio_cpid_get(
        const sx_api_handle_t   handle,
        const sx_port_log_id_t  log_port,
        const sx_cos_priority_t priority,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_profile_set(
        const sx_api_handle_t               handle,
        const sx_access_cmd_t               cmd,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_profile_get(
        const sx_api_handle_t               handle,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_port_profile_bind_set(
        const sx_api_handle_t           handle,
        const sx_access_cmd_t           cmd,
        const sx_port_log_id_t          log_port,
        const sx_cos_qcn_profile_id_t   profile_id);
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_port_profile_bind_get(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
              sx_cos_qcn_profile_id_t   *profile_id_p);
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_general_param_set(
        const sx_api_handle_t       handle,
 ...
 * @return SX_STATUS_ERROR general error
 */
sx_status_t sx_api_cos_qcn_general_param_get(
        const sx_api_handle_t       handle,
        const sx_swid_t             swid,
