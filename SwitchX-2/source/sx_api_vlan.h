 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_vlan_port_ingr_filter_set(
        const sx_api_handle_t       handle,
        const sx_port_log_id_t      log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_vlan_port_ingr_filter_get(
        const sx_api_handle_t       handle,
        const sx_port_log_id_t      log_port,
 ...
 * @param[in] handle             - SX-API handle
 * @param[in] log_port           - logical port number
 * @param[in] accptd_frm_types_p - a pointer to struct holding the following
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_vlan_port_qinq_mode_set(
        const sx_api_handle_t   handle,
        const sx_port_log_id_t  log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_vlan_port_qinq_mode_get(
        const sx_api_handle_t   handle,
        const sx_port_log_id_t  log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_vlan_port_qinq_outer_prio_mode_set(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_vlan_port_qinq_outer_prio_mode_get(
        const sx_api_handle_t           handle,
        const sx_port_log_id_t          log_port,
