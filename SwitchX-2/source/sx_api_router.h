 ...
 */
sx_status_t sx_api_router_log_verbosity_level_set(
 ...
 * @return SX_STATUS_ERROR for a general error
 */
sx_status_t sx_api_router_log_verbosity_level_get(
        const sx_api_handle_t           handle,
        const sx_log_verbosity_target_t verbosity_target,
 ...
 */
sx_status_t sx_api_router_ecmp_hash_params_set(
		const sx_api_handle_t handle,
 ...
 * @return SX_STATUS_ERROR general error.
 */
sx_status_t sx_api_router_ecmp_hash_params_get(
		const sx_api_handle_t handle,
 ...
 */
sx_status_t
sx_api_router_deinit_set(const sx_api_handle_t handle);
...
/**
 *  This function adds/modifies/deletes an unicast route into the routing table.
 ...
 *      uc_route_get_entries_cnt_p  should be equal to 1. cmd
 *      should be SX_ACCESS_CMD_GET.
 *
 *   - 2) get a list of first n<=64 routes - you should
 ...
 *
 *   - 3) get a list of n<=64 routes  which comes after certain
...
* @param[out] mc_router_attr_p -multicast route attribute
*       (e.g. rpf mode,ttl ... )
